    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12 panel panel-default">
          ...
          <p class="text-center">Add Inventory Item</p>
          <p class="text-center clash"><?php if(isset($_SESSION['message'])) echo $_SESSION['message']; ?></p>
          <form method="POST" action="addstock.php" enctype="multipart/form-data">
            <div class="form-group form-adjust">
              ...
              <input type="number" name="prod_qty" id="prod_qty" required>
              <p><label for="prod_price">Price</label></p>
              <p><input type="number" name="prod_price" id="prod_price" required></p>
              <p><label for="prod_desc">Description</label></p>
              <p><input type="text" name="prod_desc" id="prod_desc"></p>
              <p><label for="image">Inventory Image</label></p>
              <p><input type="file" name="image" id="image"></p>
            </div>
            <p class="text-center"><input type="submit" name="submit" class="btn btn-success" value="Add to Inventory"/> <input type="reset" class="btn btn-success" value="Clear Form"/></p>
          </form>
        </div>
      </div>
    </div>
