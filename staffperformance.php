<?php
  ...
  $result = $mysqli->query("SELECT full_name, COUNT(full_name) as StaffCount FROM booking GROUP BY full_name");
    ...
    <div class="container-fluid"> 
      <div class="row content">
        <div class="col-xs-12">
          ...
          <h5>Staff Mode</h5>
          <p><strong>Your Currently viewing all Staff Performance</strong></p>
